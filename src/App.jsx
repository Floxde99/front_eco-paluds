...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-gradient-to-r from-pink-500 to-violet-500 rounded-lg flex items-center justify-center shadow-md">
                  <span className="text-white font-bold text-sm">M</span>
                </div>
                <h1 className="text-white text-xl font-bold tracking-wide">Mon App ✨</h1>
              </div>
            </div>
              ...
              <div className="ml-10 flex items-baseline space-x-4">
                {['Accueil', 'À propos', 'Services', 'Contact'].map((item) => (
                  <a 
                    key={item}
                    href="#" 
                    className="text-white hover:text-purple-300 px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500"
                  >
                    {item}
                  </a>
                ))}
            ...
            <div className="md:hidden">
              <button className="text-white hover:text-purple-300 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500">
      ...
      {/* Hero Section */}
      <header className="relative z-10 text-center py-20 px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-wide animate-fade-in">
          Bienvenue sur <span className="text-purple-400">Mon App</span>
        </h2>
        <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto animate-fade-in">
          Découvrez nos services et profitez d'une expérience unique.
        </p>
        <div className="mt-8 flex justify-center space-x-4 animate-fade-in">
          <a href="#services" className="px-6 py-3 bg-purple-600 text-white rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
            Nos Services
          </a>
          <a href="#contact" className="px-6 py-3 bg-gray-100 text-gray-800 rounded-lg shadow-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-300">
            Contactez-nous
          </a>
        </div>
      </header>
